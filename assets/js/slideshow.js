...
// Not every page has a popup. Guard on both elements actually existing —
// without this, popupClose.addEventListener() throws on any page missing
// one and silently kills every script below it on the page, including the
// corner-nav and header-title collision fixes further down this file.
if (popup && popupClose) {
